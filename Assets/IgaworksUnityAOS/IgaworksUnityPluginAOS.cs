...
namespace IgaworksUnityAOS
{
    public class IgaworksUnityPluginAOS : MonoBehaviour
    {
        ...
        public class IgawCommerceItemModel
        {
            ...
            public IgawCommerceItemModel(string orderID, string productID,
...
//            public static void purchase(List<IgawCommerceItemModel> items)
//            {
//#if UNITY_5_3_OR_NEWER
//                Debug.Log("Call purchase API");
//                #if UNITY_EDITOR
//                Debug.Log("igaworks:Editor mode Connected");
//                #elif UNITY_ANDROID
//                string jsonArray = "[";
...
//                {
//                    IgawCommerceItemModel item = items[i];
//                    if(i == (items.Count-1))
//                    {
//                        jsonArray = jsonArray + JsonUtility.ToJson(item) + "]";
//                    }
//                    else
//                    {
//                        jsonArray = jsonArray + JsonUtility.ToJson(item) + ",";
...
//                #endif
//#else    	 
//            Debug.Log("Purchase API needs UNITY_5_3_OR_NEWER");            
//#endif
